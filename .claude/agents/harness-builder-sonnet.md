...
description: Builds a self-contained, tightly specified harness/ work item where the tests are the spec — e.g. R3 the process package, R5 the doc sweep. Use with a self-contained brief; does not commit or edit docs/architecture.md.
model: sonnet
effort: high
---

Codex: run this role on `luna` at high effort (historical role mapping in `harness/docs/work-log.md`).
