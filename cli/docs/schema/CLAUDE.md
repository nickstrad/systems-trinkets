...
Keep `index.html` and `erd.html` current whenever `cli/db.go` schema SQL or migrations, store-layer semantics, foreign-key behavior, indexes, or CLI deletion behavior changes.
